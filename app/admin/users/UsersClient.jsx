                  ...
                  users.map((u) => (
                    <tr key={u._id || u.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        {u?._id == user?.id ? (
                          <Link href="/admin/profile" className="text-blue-700">
                            Go to profile
                          </Link>
                        ) : (
                          <>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border text-gray-600 border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#559F34]"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full border border-gray-300 text-gray-600 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#559F34] disabled:bg-gray-100"
                />
              </div>
              ...
              <div className="mt-6 flex justify-end gap-3 border-t pt-4">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="px-4 py-2 bg-[#559F34] text-white rounded-md hover:bg-[#438228] disabled:bg-gray-400"
                >
