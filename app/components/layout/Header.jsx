    ...
    <>
      ...
      <div className="hidden px-2 md:px-4 lg:px-8 xl:px-16 2xl:px-32 md:flex items-center justify-between h-20 z-100 overflow-hidden">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 top-0 h-full flex items-center">
                {searchQuery && (
                  <button
                    onClick={clearSearch}
                    className="px-2 text-gray-300 hover:text-gray-600 transition-colors"
                  >
        ...
        <div className="flex items-center space-x-4 text-[#3A393D]">
          <Link
            href="/"
            className="hover:text-[#3A393D] text-sm relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-[#7ECB2A] after:transition-all after:duration-300 hover:after:w-full"
          >
            HOME
          </Link>
          <Link
